...
Supported capabilities are `shell`, `read_file`, `write_file`, `edit_file`, and `image_tool`. Validate incoming JSON with `parseToolInvocation` or `parseClientToolResult` before using it.
